...
import { Shield, Lock, User as UserIcon, Loader2, AlertTriangle, ChevronRight } from 'lucide-react';
      ...
      >
        <div className="text-center mb-10">
          <motion.div 
            ...
            className="inline-flex p-4 bg-blue-600 rounded-2xl mb-6 shadow-[0_0_40px_rgba(37,99,235,0.3)] relative group"
          >
          ...
          >
            Institutional Surveillance Access • Node 0-7
          </motion.p>
        </div>
        ...
        <div className="glass-card p-10 bg-brand-bg/50 backdrop-blur-3xl border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.6)] rounded-[2.5rem]">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              <label className="block text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-3 ml-1">Operator Identifier</label>
            ...
            >
              <label className="block text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-3 ml-1">Security Keyplate</label>
              <div className="relative group">
            ...
            {error && (
              ...
              >
                ...
                <span>Protocol Violation: {error}</span>
              </motion.div>
            )}
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-5 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-[0_20px_40px_rgba(37,99,235,0.2)] hover:shadow-[0_20px_60px_rgba(37,99,235,0.4)] transition-all active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-3"
            >
              {loading ? (
          ...
          <div className="mt-10 pt-10 border-t border-white/5 text-center flex flex-col gap-4">
            ...
            >
              Unregistered? Initialize Account <ChevronRight size={14} />
            </Link>
            <p className="text-[8px] text-slate-600 leading-relaxed uppercase tracking-[0.3em] font-black opacity-40">
              Authorized personnel only. Dynamic endpoint tracking enabled.<br/>
              Vector integrity: 0x{Math.random().toString(16).slice(2, 10).toUpperCase()}
            </p>
          </div>
        </div>
